...
{id:'f6-01', title:'贈与の基礎と贈与税の課税財産', tags:[], blocks:[
 ...
 {t:'fig', cap:'死因贈与は相続税、法人からの贈与は所得税。名前に引きずられないことが得点源になります。', svg:'<svg viewBox="0 0 520 258" role="img" aria-label="贈与税がかかるものとかからないものを左右に分けた図"><g fill="currentColor" font-size="11.5"><defs><marker id="a601" viewBox="0 0 10 10" refX="9" refY="5" markerWidth="7" markerHeight="7" orient="auto-start-reverse"><path d="M0 0 L10 5 L0 10 z" fill="currentColor"/></marker></defs><text x="140" y="20" font-size="12.5" text-anchor="middle" class="ng-f" font-weight="700">贈与税がかかる</text><text x="390" y="20" font-size="12.5" text-anchor="middle" class="ac-f" font-weight="700">贈与税はかからない</text><line x1="260" y1="28" x2="260" y2="206" stroke="currentColor" stroke-width="1" opacity="0.3"/><rect x="12" y="38" width="236" height="28" rx="5" class="ng-f" opacity="0.14"/><text x="130" y="57" font-size="9.5" text-anchor="middle">個人から個人への贈与</text><rect x="12" y="74" width="236" height="28" rx="5" class="ng-f" opacity="0.14"/><text x="130" y="93" font-size="9.5" text-anchor="middle">保険料を負担していない人が受け取る満期保険金</text><rect x="12" y="110" width="236" height="28" rx="5" class="ng-f" opacity="0.14"/><text x="130" y="129" font-size="9.5" text-anchor="middle">著しく低い価額での譲受け（低額譲受）</text><rect x="12" y="146" width="236" height="28" rx="5" class="ng-f" opacity="0.14"/><text x="130" y="165" font-size="9.5" text-anchor="middle">債務免除を受けた利益</text><rect x="272" y="38" width="236" height="26" rx="5" class="ac-f" opacity="0.14"/><text x="390" y="56" font-size="9.5" text-anchor="middle">扶養義務者からの通常必要な生活費・教育費</text><rect x="272" y="72" width="236" height="26" rx="5" class="ac-f" opacity="0.14"/><text x="390" y="90" font-size="9.5" text-anchor="middle">社会通念上相当な 香典・祝金・見舞金</text><rect x="272" y="106" width="236" height="26" rx="5" class="ac-f" opacity="0.14"/><text x="390" y="124" font-size="9.5" text-anchor="middle">法人からの贈与 → 所得税（一時所得）</text><rect x="272" y="140" width="236" height="26" rx="5" class="ac-f" opacity="0.14"/><text x="390" y="158" font-size="9.5" text-anchor="middle">死因贈与 → 相続税</text><rect x="272" y="174" width="236" height="26" rx="5" class="ac-f" opacity="0.14"/><text x="390" y="192" font-size="9.5" text-anchor="middle">相続開始年に被相続人から受けた贈与 → 相続税</text><text x="260" y="226" font-size="12" text-anchor="middle" font-weight="700">名前は「贈与」でも税目が変わるものに注意</text><text x="260" y="246" font-size="10.5" text-anchor="middle">贈与契約は口頭でも成立する。書面によらない贈与は、履行の済んでいない部分だけ撤回できる</text></g></svg>'},
...
{id:'f6-07', title:'財産の評価', tags:['超頻出'], blocks:[
 ...
 {t:'ul',x:['<b>貸家</b>＝固定資産税評価額 ×（1 − <u>借家権割合</u> × 賃貸割合）。<u>借地権割合は使わない</u>（貸家建付地との違い）。','<b>取引相場のない株式</b>：同族株主以外の株主等が取得した場合は、特例的評価方式である<u>配当還元方式</u>で評価する。同族株主なら原則的評価方式（類似業種比準方式・純資産価額方式）。']},
