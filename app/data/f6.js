...
{id:'f6-03', title:'相続人と相続分', tags:['超頻出'], blocks:[
 ...
 {t:'fig', cap:'配偶者の取り分は、相手が子なら1/2、直系尊属なら2/3、兄弟姉妹なら3/4と増えていきます。', svg:'<svg viewBox="0 0 520 226" role="img" aria-label="相続人の組み合わせごとの法定相続分を帯グラフで示した図。配偶者の取り分は子とで2分の1、直系尊属とで3分の2、兄弟姉妹とで4分の3"><g fill="currentColor" font-size="11.5"><text x="8" y="50" font-size="11.5" font-weight="700">配偶者と子</text><rect x="140" y="28" width="180.0" height="34" rx="5" fill="#0f6b4f" opacity="0.28"/><rect x="320.0" y="28" width="180.0" height="34" rx="5" fill="currentColor" opacity="0.13"/><text x="230.0" y="50" text-anchor="middle" font-size="11.5" font-weight="700" fill="#0f6b4f">配偶者 1/2</text><text x="410.0" y="50" text-anchor="middle" font-size="11.5" font-weight="700">子 1/2</text><line x1="320.0" y1="24" x2="320.0" y2="66" stroke="currentColor" stroke-width="1.4" opacity="0.5"/><text x="8" y="114" font-size="11.5" font-weight="700">配偶者と直系尊属</text><rect x="140" y="92" width="240.0" height="34" rx="5" fill="#0f6b4f" opacity="0.28"/><rect x="380.0" y="92" width="120.0" height="34" rx="5" fill="currentColor" opacity="0.13"/><text x="260.0" y="114" text-anchor="middle" font-size="11.5" font-weight="700" fill="#0f6b4f">配偶者 2/3</text><text x="440.0" y="114" text-anchor="middle" font-size="11.5" font-weight="700">直系尊属 1/3</text><line x1="380.0" y1="88" x2="380.0" y2="130" stroke="currentColor" stroke-width="1.4" opacity="0.5"/><text x="8" y="178" font-size="11.5" font-weight="700">配偶者と兄弟姉妹</text><rect x="140" y="156" width="270.0" height="34" rx="5" fill="#0f6b4f" opacity="0.28"/><rect x="410.0" y="156" width="90.0" height="34" rx="5" fill="currentColor" opacity="0.13"/><text x="275.0" y="178" text-anchor="middle" font-size="11.5" font-weight="700" fill="#0f6b4f">配偶者 3/4</text><text x="455.0" y="178" text-anchor="middle" font-size="11.5" font-weight="700">兄弟姉妹 1/4</text><line x1="410.0" y1="152" x2="410.0" y2="194" stroke="currentColor" stroke-width="1.4" opacity="0.5"/><text x="140" y="216" font-size="11">同順位が複数いれば、その取り分を人数で均等に分ける</text></g></svg>'},
...
{id:'f6-05', title:'相続税の課税財産と基礎控除', tags:['超頻出'], blocks:[
 ...
 {t:'fig', cap:'相続人が3人なら3,000万＋600万×3＝4,800万円。ここを超えた部分にだけ相続税がかかります。', svg:'<svg viewBox="0 0 520 200" role="img" aria-label="遺産総額から債務と葬式費用を引き、さらに3000万円と600万円かける法定相続人の数を引いたものが課税遺産総額になることを示す図"><g fill="currentColor" font-size="11.5" text-anchor="middle"><text x="260" y="18" font-size="12.5" font-weight="700">基礎控除 = 3,000万円 + 600万円 x 法定相続人の数</text><rect x="20" y="34" width="480" height="40" rx="6" fill="none" stroke="currentColor" stroke-width="1.4"/><text x="260" y="59" font-size="12">遺産総額（相続人が3人のケース）</text><rect x="20" y="96" width="150" height="44" rx="5" fill="#0f6b4f" opacity="0.26" stroke="currentColor" stroke-width="0.8"/><text x="95" y="123" font-size="11">3,000万円</text><rect x="170" y="96" width="60" height="44" rx="5" fill="#0f6b4f" opacity="0.2" stroke="currentColor" stroke-width="0.8"/><text x="200" y="123" font-size="11">600万</text><rect x="230" y="96" width="60" height="44" rx="5" fill="#0f6b4f" opacity="0.2" stroke="currentColor" stroke-width="0.8"/><text x="260" y="123" font-size="11">600万</text><rect x="290" y="96" width="60" height="44" rx="5" fill="#0f6b4f" opacity="0.2" stroke="currentColor" stroke-width="0.8"/><text x="320" y="123" font-size="11">600万</text><rect x="350" y="96" width="150" height="44" rx="5" fill="currentColor" opacity="0.12" stroke="currentColor" stroke-width="0.8"/><text x="425" y="123" font-size="11">課税遺産総額</text><line x1="20" y1="150" x2="350" y2="150" stroke="#0f6b4f" stroke-width="1.6"/><text x="185" y="166" font-size="12" font-weight="700" fill="#0f6b4f">基礎控除 4,800万円（ここまで非課税）</text><text x="260" y="190" font-size="11">相続放棄した人も「人数」には含めて数える</text></g></svg>'},
...
{id:'f6-07', title:'財産の評価', tags:['超頻出'], blocks:[
 ...
 {t:'fig', cap:'330・400・200と80%・80%・50%の組み合わせで覚えます。適用するには相続税の申告が必要です。', svg:'<svg viewBox="0 0 520 206" role="img" aria-label="小規模宅地等の特例の限度面積と減額割合。居住用は330平米で80パーセント、事業用は400平米で80パーセント、貸付用は200平米で50パーセント"><g fill="currentColor" font-size="11.5"><text x="8" y="40" font-size="11.5" font-weight="700">特定居住用宅地等</text><rect x="160" y="26" width="247.5" height="26" rx="5" fill="#0f6b4f" opacity="0.24" stroke="#0f6b4f" stroke-width="1.2"/><text x="283.8" y="44" text-anchor="middle" font-size="11.5" font-weight="700" fill="#0f6b4f">330平米まで</text><text x="470" y="45" text-anchor="end" font-size="15" font-weight="700" fill="#0f6b4f">80%減</text><text x="8" y="56" font-size="10" opacity="0.7">自宅の敷地</text><text x="8" y="94" font-size="11.5" font-weight="700">特定事業用宅地等</text><rect x="160" y="80" width="300.0" height="26" rx="5" fill="#b2632a" opacity="0.24" stroke="#b2632a" stroke-width="1.2"/><text x="310.0" y="98" text-anchor="middle" font-size="11.5" font-weight="700" fill="#b2632a">400平米まで</text><text x="470" y="99" text-anchor="end" font-size="15" font-weight="700" fill="#b2632a">80%減</text><text x="8" y="110" font-size="10" opacity="0.7">店舗や工場の敷地</text><text x="8" y="148" font-size="11.5" font-weight="700">貸付事業用宅地等</text><rect x="160" y="134" width="150.0" height="26" rx="5" fill="#8a4f9e" opacity="0.24" stroke="#8a4f9e" stroke-width="1.2"/><text x="235.0" y="152" text-anchor="middle" font-size="11.5" font-weight="700" fill="#8a4f9e">200平米まで</text><text x="470" y="153" text-anchor="end" font-size="15" font-weight="700" fill="#8a4f9e">50%減</text><text x="8" y="164" font-size="10" opacity="0.7">アパートや駐車場</text><text x="8" y="196" font-size="11">居住用と事業用は完全併用できて合計730平米。貸付用を混ぜるときは調整計算が必要</text></g></svg>'},
