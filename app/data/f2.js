...
{id:'f2-01', title:'保険の基本と契約者保護', tags:['頻出'], blocks:[
 ...
 {t:'ul',x:['<b>保険料を決める3つの予定率</b>：予定死亡率・予定利率・予定事業費率。<u>予定利率が高いほど保険料は安くなる</u>（運用で増える前提であらかじめ割り引くため）。','<b>契約者配当金</b>：予定と実際のズレで余りが出たときに契約者へ返すお金。死差益・利差益・費差益の3つが原資。<u>配当のある有配当保険は、無配当保険より保険料が高め</u>に設定されます。','<b>責任準備金</b>：将来の保険金支払いに備えて保険会社が積み立てておくお金。法律で積立が義務づけられています。']},
 {t:'ex',q:'契約者配当金は必ず支払われますか。',a:'いいえ。<b>予定と実際の差で余りが出たときだけ</b>です。運用が予定利率を下回れば配当はゼロもあり得ます。名前は「配当」でも、株の配当のような利益の分配ではなく<u>もらいすぎた保険料の払い戻し</u>だと考えると腑に落ちます。'},
 {t:'ul',x:['<b>リスクへの対応は4つ</b>に整理されます。<u>回避</u>（そもそもやらない）、<u>軽減</u>（起こりにくくする・被害を小さくする）、<u>保有</u>（自分で引き受ける）、<u>移転</u>（他人に引き受けてもらう）。<b>保険は「移転」</b>にあたります。めったに起きないが起きたら困る＝保険向き、よく起きるが被害が小さい＝保有向き、という住み分けです。']},
...
{id:'f2-07', title:'傷害保険・賠償責任保険・第三分野', tags:[], blocks:[
 ...
 {t:'p',x:'<b>働けなくなったとき</b>の保険も第三分野で問われます。名前が似ていて紛らわしいので、<u>生きているのか亡くなったのか</u>で切り分けてください。'},
 {t:'table',head:['','扱う会社','何を補うか','ポイント'],rows:[['<b>所得補償保険</b>','損害保険会社','病気・ケガで<b>働けない間の収入</b>','<u>業務上・業務外どちらでも</u>対象。入院していなくても、医師の指示による自宅療養なら支払われる'],['<b>就業不能保険</b>','生命保険会社','同じく働けない間の収入','長期の就業不能に備える。支払対象外期間（免責期間）が60日などと長めのことが多い'],['<b>収入保障保険</b>','生命保険会社','<u>死亡後</u>の遺族の生活費','働けないときではなく<b>亡くなったとき</b>に年金形式で支払う。名前が似ているだけの別物']]},
 {t:'warn',x:'<b>所得補償保険と収入保障保険は別物</b>です。所得補償＝<u>生きているが働けない</u>、収入保障＝<u>死亡</u>。名前だけで選ぶと必ず落とします。'},
